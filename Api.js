export default {
    ...
    homeIcons: [{
      "title" : "美食",
      "icon" : require('./images/ms.png')
    },
    {
      "title" : "电影",
      "icon" : require('./images/dy.png')
    },
    {
      "title" : "酒店",
    ...
    {
      "title" : "休闲娱乐",
      "icon" : require('./images/xxyl.png')
    },
    {
      "title" : "外卖",
      "icon" : require('./images/wm.png')
    },
    {
      "title" : "自助餐",
      "icon" : require('./images/zzc.png')
    },
    {
      "title" : "KTV",
    ...
    {
      "title" : "火车票机票",
      "icon" : require('./images/hcpjp.png')
    },
    {
      "title" : "丽人",
      "icon" : require('./images/lr.png')
    },
    {
        "title" : "周边游",
        "icon" : require('./images/zby.png')
    },
    {
      "title" : "足疗按摩",
      "icon" : require('./images/zlam.png')
    },
    {
      "title" : "购物",
      "icon" : require('./images/gw.png')
    },
    {
      "title" : "今日新单",
      "icon" : require('./images/jrxd.png')
    },
    {
      "title" : "小吃快餐",
      "icon" : require('./images/xckc.png')
    },
    {
      "title" : "生活服务",
      "icon" : require('./images/shfw.png')
    },
      {
        "title" : "甜点饮品",
        "icon" : require('./images/tdyp.png')
      },
    {
      "title" : "美甲",
      "icon" : require('./images/mj.png')
    },
    {
      "title" : "景点门票",
      "icon" : require('./images/jdmp.png')
    },
    {
      "title" : "旅游",
      "icon" : require('./images/ly.png')
    },
    {
      "title" : "全部分类",
      "icon" : require('./images/qbfl.png')
    }],

  HomeSpecialData: {
    "dataLeft": {"img1" : require('./images/mdqg.png'), "img2" : require('./images/yyms.png'), "title" : "探路组碳烤鱼", "price": "¥9.5", "sale": "再减3元"},
    "dataRight":[
      {"title" : "天天特价", "subTitle" : "特惠不打烊", "rightImage" : require('./images/tttj.png'), "titleColor": "orange"},
      {"title" : "一元吃", "subTitle" : "一元吃美食", "rightImage" : require('./images/yyms.png'), "titleColor": "red"}
    ]
  }
}
